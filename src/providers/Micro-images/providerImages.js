...
export const compararSelfies = async (linkSelfie, curp) => {
  try {
    ...
    const url = `https://ms-biometrico-2.herokuapp.com/api/selfie?nombreUser=${linkSelfie}&nombreUser2=${data.selfie}`;
...
export const verificarCredencial = async ({
  ...
  try {
    ...
    const url = `https://ms-biometrico-2.herokuapp.com/api/usuario?nombreUser=${uriCredSelfieCrop}&nombreUser2=${uriCredFrontalCrop}`;
