            ...
            {status === "checking" ? (
              ...
              <>
                ...
                >
                  ...
                  <Button color="base" onClick={handleReenviarToken} variant="outlined">
                    Reenviar enlace
                  </Button>
                </Box>
              </>
            ...
            {status === "checking" ? (
              ...
              <>
                ...
                <Typography
                  ...
                  mb="2rem"
                >
                  La contraseña debe contener mínimo 6 caracteres, una mayúscula, una minúscula, un
                  numero y un simbolo ($%&/?...)
                </Typography>
                <Formik
                  initialValues={{
                          ...
                          endAdornment: (
                            <InputAdornment position="end">
                              <Box
                                ...
                                justifyContent="center"
                              >
                                <IconButton onClick={() => setVisible2(!visible2)} edge="end">
                                  {visible2 ? (
                                    <Visibility htmlColor="white" />
                                  ) : (
                                    <VisibilityOff htmlColor="white" />
