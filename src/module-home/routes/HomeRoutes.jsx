...
=======
  return (
    <Routes>
      ...
      <Route path="verificacion/individual" element={<IndividualPage />} />
      <Route
        path="verificacion/individual/FoundFolio"
        element={<FolioFound />}
      />
      <Route
        path="/verificacion/individual/:folio/FoundFolio"
        element={<FolioFound />}
      />
      {/* No Logueado */}
      <Route path="verificacion/visualizacion" element={<Jornadas />} />
      <Route
        path="verificacion/visualizacion/boleta"
        element={<VisualizacionBoleta />}
      />
      <Route
        path="verificacion/visualizacion/boleta/:id"
        element={<VisualizacionBoleta />}
      />
      <Route
        path="verificacion/visualizacion/boleta/group"
        element={<GroupPage />}
      />
      <Route
        path="verificacion/visualizacion/boleta/:id/group/:idBoleta"
      ...
      {/*Logueado */}
      <Route
        path="verificacion/visualizacionnf"
        element={<JornadasNoFormales />}
      />
      <Route
        path="verificacion/visualizacionnf/boletanf"
        element={<VisualizacionBoletaNoFormal />}
