...
export const HomePage = () => {
  ...
  const goVotar = () => {
    if (logged !== "logged") navigate("/auth/login");
              ...
              {tick === "circuloAuto1" ? (
                <Box position={"absolute"}>
                  <Typography
                    ...
                    textAlign="center"
                  >
                    ¡Entra a tu votación o consulta correspondiente dando click aquí!
                  </Typography>
                </Box>
              ) : (
              ...
              {tick === "circuloAuto2" ? (
                <Box position={"absolute"}>
                  <Typography
                    ...
                    textAlign="center"
                  >
                    ¿Quieres verificar los resultados de votaciones y/o consultas previas? ¡Da click
                    aquí!
                  </Typography>
                </Box>
              ) : (
              ...
              {tick === "circuloAuto3" ? (
                <Box position={"absolute"}>
                  <Typography
                    ...
                    textAlign="center"
                  >
                    ¿Quieres verificar que realizaste correctamente tu voto? ¡Da click aquí!
                  </Typography>
                </Box>
              ) : (
                <Box position="absolute" display="flex" flexDirection="column">
              ...
              {tick === "circuloAuto4" ? (
                <Box position={"absolute"}>
                  <Typography
                    ...
                    textAlign="center"
                  >
                    ¿Necesitas información sobre los diferentes procesos? ¡Da click aquí!
                  </Typography>
                </Box>
              ) : (
                <Box position="absolute" display="flex" flexDirection="column">
