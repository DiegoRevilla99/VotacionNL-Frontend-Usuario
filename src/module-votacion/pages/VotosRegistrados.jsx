...
export const VotosRegistrados = () => {
  ...
  const onSubmit = () => {
    ...
    if (jornadaActual.tipoJornada === "JornadaFormal") {
      ...
      const votosObject = votos.map((boleta, indexBoleta) => {
        ...
        const partidos = boleta.map((idPartido) => {
          if (idPartido === 100)
            ...
            return {
              idCandAso: idPartido,
              nombreCandidato: boletaCurrent.modalidad === "PLANILLA" ? nomPlanilla : nomCandidato,
            };
          }
        });
        return {
      ...
      dispatch(
        onEmitirVotoNoFormal(votosObjectCoaliciones, jornadaActual.idJornada, username, () =>
          navigate("/votacion/folios")
        )
      );
    }
        ...
        voto.selecciones.every((seleccion, indexSeleccion) => {
          ...
          candidatosId.every((candidato) => {
            ...
            if (result) {
              ...
              console.log("candidatosId", candidatosId);
