...
export const InicioVotante = () => {
  ...
  useEffect(() => {
    ...
    else if (imagenes.current === "credTrasera") imgURL = URL.createObjectURL(imagenes.credTrasera);
  ...
  const handleComezarjornadaNoFormal = () => {
    dispatch(
      onComenzarJornadaNoFormal(jornadaNoFormal, username, () => navigate("/votacion/boletas"))
    );
  };
                  ...
                  <Box width="100%" height="100%" position="relative">
                    ...
                    {verificado && jornadaFormal !== null ? (
                      ...
                      >
                        ...
                        <Box>
                          {statusBoton.jornadaFormal === "en espera" ? (
                            <TemporizadorInicio
                              fechaInicio={jornadaFormal.requestConfigJornada.inicioRecepVoto}
                            ...
                            <TemporizadorFin
                              fechaFin={jornadaFormal.requestConfigJornada.finRecepVoto}
                              setStatusBoton={setStatusBoton}
                              statusBoton={statusBoton.jornadaFormal}
                              boton={"jornadaFormal"}
                        ...
                        <Button
                          ...
                          onClick={selfieVerificada ? handleOpenModal : handleOpenModalCamara}
                          sx={{
                            boxShadow: "0px 0px 0px rgba(0, 0, 0, 0.3)",
                            transition: "all 0.5s ease",
                            width: { xs: "100%", md: "50%" },
                      ...
                      <Box width="100%" height="100%" position="relative">
                        ...
                        >
                          <Box p={2} mt={4} border="1px solid #f8f7f3" borderRadius="2rem">
                            {statusJornadas === "checking" ? (
                              <Box sx={{ display: "flex" }}>
                      ...
                      >
                        ...
                        <Box>
                          {statusBoton.jornadaNoFormal === "en espera" ? (
                            <TemporizadorInicio
                              fechaInicio={jornadaNoFormal.requestConfigJornada.inicioRecepVoto}
                              setStatusBoton={setStatusBoton}
                            ...
                            <TemporizadorFin
                              fechaFin={jornadaNoFormal.requestConfigJornada.finRecepVoto}
                              setStatusBoton={setStatusBoton}
                              statusBoton={statusBoton.jornadaNoFormal}
                              boton={"jornadaNoFormal"}
                      ...
                      >
                        ...
                        <Box>
                          {statusBoton.consultaCiudadana === "en espera" ? (
                            <TemporizadorInicio
                              fechaInicio={consultaCiudadana.requestConfigJornada.inicioRecepVoto}
                              setStatusBoton={setStatusBoton}
                            ...
                            <TemporizadorFin
                              fechaFin={consultaCiudadana.requestConfigJornada.finRecepVoto}
                              setStatusBoton={setStatusBoton}
                              statusBoton={statusBoton.consultaCiudadana}
                              boton={"consultaCiudadana"}
