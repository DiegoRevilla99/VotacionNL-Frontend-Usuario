...
export const ModalVerificarCuenta = ({
  ...
  let img2 =
    "https://media.discordapp.net/attachments/825115444800258088/1078083538785669180/image.png?width=528&height=480";
  let img1 =
    "https://media.discordapp.net/attachments/825115444800258088/1078083844412026881/imageMostrar01.png";
  let img3 =
    "https://media.discordapp.net/attachments/825115444800258088/1078084391907106846/image.png?width=510&height=480";
      ...
      <Container maxWidth="lg" sx={style}>
        ...
        >
          ...
          <Typography
            ...
            mb="1rem"
          >
            Para garantizar la seguridad de tu cuenta y confirmar que eres su dueño legítimo,
            necesitamos que completes un proceso de verificación. Para hacerlo, por favor sube tres
            fotos: una de la parte frontal de tu credencial, otra de la parte trasera y una foto de
            ti mismo. Una vez que hayamos recibido y revisado tus fotos, podrás disfrutar de todos
            los beneficios de tu cuenta. Gracias por tu colaboración en este proceso de seguridad.
          </Typography>
          <Typography
          ...
          <Typography
            ...
            color="red" // Utiliza el color "pink" en lugar de "red"
          >
            3.- DALE UN MARGEN A LAS FOTOGRAFIAS AL MOMENTO DE TOMARLAS, COMO SE MUESTRA EN LA
          ...
          {xssize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="100%" height="100%" src={img1} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {smsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="70%" height="70%" src={img1} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {mdsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="75%" height="75%" src={img1} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {lgsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="80%" height="80%" src={img1} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {xlsize && (
          ...
          {xssize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="100%" height="100%" src={img2} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {smsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="70%" height="70%" src={img2} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {mdsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="75%" height="75%" src={img2} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {lgsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="80%" height="80%" src={img2} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {xlsize && (
          ...
          {xssize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="100%" height="100%" src={img3} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {smsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="70%" height="70%" src={img3} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {mdsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="75%" height="75%" src={img3} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {lgsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="80%" height="8%" src={img3} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          {xlsize && (
            <Box display="flex" justifyContent="center" alignItems="center">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img width="80%" height="80%" src={img3} alt="Logo coalición" />
              </Box>
            </Box>
          )}
          <Divider />
          ...
          >
            <FormControl fullWidth sx={{ m: 1 }} size="small">
              ...
              <OutlinedInput
                ...
                disabled
                value={imagenes?.credFrontal?.name || "Foto de la parte delantera de tu credencial"}
                endAdornment={
                      ...
                      onChange={(e) =>
                        setImagenes((i) => {
                          return {
                            ...
                            current: !e.target.files[0] ? "" : "credFrontal",
                          };
                        })
                      }
                    />
            ...
            <FormControl fullWidth sx={{ m: 1 }} size="small">
              ...
              <OutlinedInput
                ...
                value={imagenes?.credTrasera?.name || "Foto de la parte trasera de tu credencial"}
                disabled
                endAdornment={
                  <IconButton
                    color="primary"
                      ...
                      onChange={(e) =>
                        setImagenes((i) => {
                          return {
                            ...
                            current: !e.target.files[0] ? "" : "credTrasera",
                          };
                        })
                      }
                    />
          ...
          >
            ...
            <Grid item xs={12} md={5} pb={{ xs: "2rem", md: "0" }}>
              <Button
                ...
                // endIcon={<SendIcon />}
                endIcon={statusPeticion === "checking" ? <CircularProgress /> : <SendIcon />}
              >
